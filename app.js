...
// Importar móculo express-handlebars
...
app.post('/cadastrar', function(req, res) {
    ...
    if(nome == '' || valor == '' || isNaN(valor)) {
        ...
        // SQL
        let sql = `INSERT INTO produtos (nome, valor, imagem)
...
app.post('/editar', function(req, res) {
    ...
    if(nome == '' || valor == '' || isNaN(valor)) {
        ...
        try{
            ...
            imagem='${imagem.name}'WHERE codigo=${codigo}`;
            ...
            conexao.query(sql, function(erro, retorno) {
                ...
                fs.unlink(__dirname+'/img/'+nomeImagem, 
                (erro_imagem)=> { console.log('Falha ao remover imagem!')});
